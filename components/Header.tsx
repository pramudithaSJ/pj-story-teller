...
function Header() {
  return (
    <header className="relative p-16 text-center">
      <Link href="/" prefetch>
        <h1 className="text-6xl font-black">PJ Story Teller</h1>
      ...
      <div className=" absolute -top-5 right-5 flex space-x-2">
        <Link href="/">
          <FilePen className="w-8 h-8 lg:w-10 lg:h-10 mx-auto p-2 mt-10 text-purple-500 border border-purple-500 rounded-md hover:opacity-50 cursor-pointer" />
        </Link>
        <Link href="/stories">
          <BookOpen className="w-8 h-8 lg:w-10 lg:h-10 mx-auto p-2 mt-10 text-purple-500 border border-purple-500 rounded-md hover:opacity-50 cursor-pointer" />
        </Link>
      </div>
    </header>
  );
